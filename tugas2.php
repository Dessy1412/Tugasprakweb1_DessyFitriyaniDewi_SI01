    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <?php
                ...
                $simpan = $_POST['simpan'];
                if($item == "Tv") {
                    $total_cost = 3000000 * $total_item + $biaya_jaminan + $biaya_kurir;
                } else if ($item == "Refrigator") {
                    $total_cost = 6000000 * $total_item + $biaya_jaminan + $biaya_kurir;
                } else{
                    $total_cost = 4000000 * $total_item + $biaya_jaminan + $biaya_kurir;
                }
            ?>
            </div>
